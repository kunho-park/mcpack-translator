...
5. 뜻을 모르는 영어를 한글로 번역하는 경우 발음을 정확하게 유지하세요. 특히 고유명사, 기술 용어, 게임 내 고유 용어는 원본 발음을 최대한 정확하게 한글로 표기하세요.
    예시: "Thermal Expansion" -> "써멀 익스팬션"
6. dictionary은 참조용일 뿐이며, 직접 복사하지 마세요.
7. dictionary에 존재하지 않는 단어는 "자연스러운 한국어"로 번역하세요.
8. dictionary에서 단어를 사용할 경우 문법에 맞게 자연스럽게 활용하세요. dictionary의 번역을 맹신하지 말고 문맥에 맞게 조정하세요.
9. dictionary에 사용된 단어가 틀렸을 경우, 변경하여 활용하세요.
11. 가능한 모든 영어를 한국어로 번역하고, 영어를 그대로 유지하는 것을 최소화하세요. 
</translation_rules>
...
2. 뜻을 모르는 영어를 한글로 번역하는 경우 발음을 정확하게 유지하세요. 특히 고유명사, 기술 용어, 게임 내 고유 용어는 원본 발음을 최대한 정확하게 한글로 표기하세요.
    예시: "Thermal Expansion" -> "써멀 익스팬션"
3. dictionary은 참조용일 뿐이며, 직접 복사하지 마세요.
4. dictionary에 존재하지 않는 단어는 자연스러운 한국어로 번역하세요.
5. dictionary에서 단어를 사용할 경우 문법에 맞게 자연스럽게 활용하세요. dictionary의 번역을 맹신하지 말고 문맥에 맞게 조정하세요.
6. dictionary에 사용된 단어가 틀렸을 경우, 변경하여 활용하세요.
7. 가능한 모든 영어를 한국어로 번역하고, 영어를 그대로 유지하는 것을 최소화하세요. 
</translation_rules>"""
